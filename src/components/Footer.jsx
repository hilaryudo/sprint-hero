            ...
            <div className='w-[1240px] h-[385px] flex items-center gap-[39px]'>
                <div className='w-[459px] h-[385px] rounded-[30px] border-[1px] border-[#1E1E1E]'>
                    <div className='w-[101px] h-[31px] flex items-center gap-[7px] mt-[29px] ml-[29px]'>
                        <img src="src/images/lizard-icon.png" alt="" className='w-[31px] h-[31px]'/>
                ...
                <div className='w-[222px] h-[385px] flex flex-col gap-[15px]'>
                    <div className='w-[222px] h-[85px] rounded-[30px] border-[1px] border-[#1E1E1E] flex flex-col gap-[20px] px-[49px] py-[26px]'>
                        <img src="src/images/twitter.png" alt="" className='mx-auto text-center w-[21px] h-[22px]' />
                    </div>
                    <div className='w-[222px] h-[85px] rounded-[30px] border-[1px] border-[#1E1E1E] flex flex-col gap-[20px] px-[49px] py-[26px]'>
                        <img src="src/images/facebook.png" alt="" className='mx-auto text-center w-[14px] h-[24px]' />
                    </div>
                    <div className='w-[222px] h-[85px] rounded-[30px] border-[1px] border-[#1E1E1E] flex flex-col gap-[20px] px-[49px] py-[26px]'>
                        <img src="src/images/linkedin.png" alt="" className='mx-auto text-center w-[25px] h-[23px]' />
                    </div>
                    <div className='w-[222px] h-[85px] rounded-[30px] border-[1px] border-[#1E1E1E] flex flex-col gap-[20px] px-[49px] py-[26px]'>
                        <img src="src/images/reddit.png" alt="" className='mx-auto text-center w-[24px] h-[24px]' />
                    </div>
                </div>
