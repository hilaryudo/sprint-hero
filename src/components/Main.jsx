...
import tiny1 from '../assets/images/tiny1.png'
import tiny2 from '../assets/images/tiny2.png'
import tiny3 from '../assets/images/tiny3.png'
import tiny4 from '../assets/images/tiny4.png'
            ...
            <div className='w-[610px] h-[422px] mt-[245px] ml-[100px]'>
                <div className='w-[610px] h-[335px] flex flex-col gap-[10px]'>
                    <div className='flex gap-[11px] w-[284px] h-[31px] rounded-[50px] px-[6px] py-[3px] bg-gray-700'>
                        <div className='flex '>
                           <img src={tiny1} alt="" className='w-[25px] h-[25px] rounded-[16px]' />
                           <img src={tiny2} alt="" className='w-[25px] h-[25px] rounded-[16px]' />
                           <img src={tiny3} alt="" className='w-[25px] h-[25px] rounded-[16px]' />
                ...
                <div className='flex items-center gap-[10px] w-[183px] h-[50px] rounded-[20px] px-[19px] py-[10px] bg-[#FFFFFF] mt-6'>
                    ...
                    <img src={tinyarrow} alt="arrow" className='w-[33px] h-[33px] rounded-[14px] border-[1px] border-[#C1C1C1] shadow-[#5D5D5D] bg-[#000000]'/>
                </div>
            </div>
               

            <div>
                <img src={man} alt="man image" className='w-[610px] h-[662px] rounded-[40px] border-[1px] border-[#151515] mt-[155px] mr-[100px]' />
            </div>
        </div>
        <Logos/>
        <div>
                ...
                <div className='w-[1240px] h-[364px] '>
                    <div className='flex justify-center mx-auto mt-[52px]'>
                        <div id='img1' className='w-[414px] h-[364px] p-5 border-y-[1px] border-[#4B4b4B] rounded-tl-[30px] rounded-bl-[30px]'>
                            <img src={img1} alt="" className='w-[373px] h-[198px] rounded-[10px]'/>
                        ...
                        <div id='img2' className='w-[414px] h-[364px] p-5 border-[1px] border-[#4B4b4B]'>
                            <img src={img2} alt="" className='w-[373px] h-[198px] rounded-[10px]'/>
                            <div className='w-[373px] h-[111px] flex flex-col gap-[12px] mt-[10px] text-start'>
                        ...
                        <div id='img3' className='w-[414px] h-[364px] p-5 border-y-[1px] border-r-[1px] border-[#4B4b4B] rounded-tr-[30px] rounded-br-[30px]'>
                            <img src={img3} alt="" className='w-[373px] h-[198px] rounded-[10px]'/>
                            <div className='w-[373px] h-[111px] flex flex-col gap-[12px] mt-[10px] text-start'>
