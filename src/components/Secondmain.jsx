...
const Secondmain = () => {
  return (
    <div>
      <div className='w-[1240px] h-[445px] mt-[170px] mx-auto'>
        <div className='flex justify-center gap-[72px]'>
          ...
          <div>
            ...
            <ul className='flex flex-col gap-[4px] w-[526px] h-[107px] mt-[18px]'>
                <li className='font-manrope font-[400] text-[18px] w-[364px] h-[33px]'>Over 100,000 viewers participated live</li>
                <li className='font-manrope font-[400] text-[18px] w-[364px] h-[33px]'>Led by Liz.co & NASA scientists</li>
                <li className='font-manrope font-[400] text-[18px] w-[364px] h-[33px]'>Lunar surface data for joint research on future missions.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className='w-[1240px] h-[445px] mt-[100px] mx-auto'>
        <div className='flex justify-center gap-[72px]'>
          <div className='w-[558px] h-[400px] flex flex-col gap-[18px]'>
            <p id='moon-watch' className='w-[558px] h-[158px] font-[400] text-[58px]'>Moon watch view with NASA</p>
            <p className='w-[558px] h-[99px] font-manrope font-[400] text-[18px] text-[#B1B1B1]'>Under the gaze of the Moon, we partnered with NASA to bring space closer than ever — a night of discovery, wonder, and breakthrough moments.</p>
            <ul className='flex flex-col gap-[4px] w-[290px] h-[107px] mt-[18px]'>
                <li className='font-manrope font-[400] text-[18px] w-[364px] h-[33px]'>Educational Outreach</li>
                <li className='font-manrope font-[400] text-[18px] w-[364px] h-[33px]'>Data Collaboration</li>
      ...
      <div className='w-[1237px] h-[697px] mt-[74px] mx-auto'>
        <div className='w-[695px] h-[144px] flex flex-col items-center mx-auto gap-[18px]'>
          <p id='our-team' className='font-[400] text-[44px] w-[695px] h-[60px]'>Our incredible team</p>
          <p className='font-manrope font-[400] text-[18px] text-[#B1B1B1] text-center w-[607px] h-[66px]'>Meet the people powering innovation, collaboration, and extraordinary results every day.</p>
        </div>
      ...
      <div className='w-[727px] h-[248px] mt-[140px] mx-auto flex flex-col gap-[30px]'>
        <div className='w-[727px] h-[144px] flex flex-col items-center gap-[18px]'>
          <p id='loop' className='w-[727px] h-[60px] font-[400] text-[44px] text-center'>Stay in the Loop, Beyond Earth</p>
          <p className='w-[727px] h-[60px] font-manrope font-[400] text-[18px] text-[#B1B1B1] text-center'>Join our cosmic circle — get the latest mission updates, behind-the-scenes insights, and discoveries sent straight to your inbox. No spam, just pure space magic.</p>
        </div>

        <div className='w-[558px] h-[74px] rounded-[30px] border-[1px] border-[#4B4B4B] mx-auto flex justify-between items-center py-[12px] pr-[16px] pl-[20px]'>
